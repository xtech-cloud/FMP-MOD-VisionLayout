...
namespace XTC.FMP.MOD.VisionLayout.LIB.Unity
{
    public class FenchLayoutAction : LayoutAction
    {
        ...
        private float moveInterval { get; set; }
        ...
        protected override void onExit()
        {
            ...
            {
                cell.dynamicX = offset + columnWidth / 2;
                offset += columnWidth;
        ...
        protected override void onUpdate()
        {
            ...
            if (timer_ + moveDuration >= duration)
                return;
            ...
            if (!isMoving_)
            {
                ...
                foreach (var cell in layoutCells_)
                {
                    ...
                    cell.animEndPos.x = cell.dynamicX - columnWidth;
                    cell.animEndPos.y = cell.dynamicY;
                    cell.target.gameObject.SetActive(true);
                }
            }

            float precentage = (intervalTimer_ - moveInterval) / moveDuration;
            if (precentage >= 1.0)
            {
                intervalTimer_ = 0f;
                precentage = 1.0f;
                ...
                first.dynamicX = last.dynamicX + columnWidth;
        ...
        protected override void layout(List<string> _contentList)
        {
            ...
            moveDuration = parseFloatFromProperty("moveDuration");
            moveInterval = parseFloatFromProperty("moveInterval");
            columnCount = parseIntFromProperty("column");
            columnWidth = canvasWidth_ / columnCount;
            int cellWidth = canvasWidth_ / columnCount;
            ...
            for (int i = 0; i < _contentList.Count || i < columnCount + 1; i++)
            {
